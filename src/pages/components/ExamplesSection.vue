        ...
        <div class="container text-center">
            <div class="row">
                <div class="col">
                    ...
                    <router-link to="/landing" class="btn btn-simple btn-primary btn-round">View Landing
                        Page
                    </router-link>
                </div>
                <div class="col">
                    ...
                    <router-link to="/profile" class="btn btn-simple btn-primary btn-round">View Profile
                        Page</router-link>
                </div>
            </div>
        </div>
