        ...
        <div class="container">
            <div class="row justify-content-md-center">
                <div class="text-center col-md-12 col-lg-8">
                    ...
                    <h5 class="description">Cause if you do, it can be yours for FREE. Hit the button below to navigate
                        to Creative Tim or Invision where you can find the kit in HTML or Sketch/PSD format. Start a new
                        project or give an old Bootstrap project a new look!</h5>
                </div>
                <div class="text-center col-md-12 col-lg-8">
                    <a href="https://www.creative-tim.com/product/vue-now-ui-kit" class="btn btn-primary btn-lg btn-round"
                       role="button">
                        Download HTML
                    </a>
                    <a href="https://www.invisionapp.com/now" target="_blank"
                       class="btn btn-primary btn-lg btn-simple btn-round" role="button">
                        Download PSD/Sketch
                    </a>
                </div>
            </div>
            ...
            <div class="row text-center mt-5">
                <div class="col-md-8 ml-auto mr-auto">
                    ...
                    <h5 class="description">We've just launched
                        <a href="http://demos.creative-tim.com/vue-now-ui-kit-pro" target="_blank">Now UI
                            Kit PRO</a>. It has a huge number of components, sections and example pages. Start Your
                        Development With A Badass Bootstrap 4 UI Kit.</h5>
                </div>
                <div class="col-md-12">
                    <a href="http://demos.creative-tim.com/vue-now-ui-kit-pro"
            ...
            <div class="row justify-content-md-center sharing-area text-center">
                ...
                <div class="text-center col-md-12 col-lg-8">
                    ...
                    <a target="_blank" href="https://github.com/creativetimofficial/vue-now-ui-kit"
